...
public class MainAspectKindsEx {
    public static void main(String[] ar) {
        ClassPathXmlApplicationContext context
                = new ClassPathXmlApplicationContext("/com/j/ch15/xml/applicationContextSchema.xml");
        ReadArticleService readArticleService = (ReadArticleService) context.getBean("readArticleService");
